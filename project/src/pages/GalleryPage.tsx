...
const GALLERY_ITEMS: GalleryItem[] = [
  ...
  { id: 34, type: 'image', src: '/images/ssjc/real/bunting-leg1.jpg',            alt: 'SSJC Leg 1 Retro Purple bunting design',  category: 'Works', caption: 'SSJC Leg 1 Bunting. Retro Purple flags carrying the identity past the poster and into the venue.' },
  { id: 41, type: 'image', src: '/images/ssjc/real/bunting-leg2.jpg',            alt: 'SSJC Leg 2 Cyber Blue bunting design',    category: 'Works', caption: 'SSJC Leg 2 Bunting. Cyber Blue chapter, same full-bleed print system.' },
  ...
  { id: 32, type: 'image', src: '/images/Thevaki-midnight.webp',                                     alt: 'Thevaki working midnight on Nandhini DC website', category: 'Behind the Scenes', caption: 'Thevaki. Midnight work on the Nandhini DC website launch for Nandhini\'s birthday.' },
