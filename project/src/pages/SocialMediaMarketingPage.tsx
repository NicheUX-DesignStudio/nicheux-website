...
const TIERS = [
  {
    ...
    features: [
      "2 platforms (Instagram, TikTok, Facebook or LinkedIn)",
  ...
  },
  {
    ...
    features: [
      "3 platforms (Instagram, LinkedIn, Facebook or TikTok)",
      "16 posts per month (static, carousel, mixed media)",
      "8 Stories per month",
  ...
  },
  {
    ...
    features: [
      ...
      "24 posts per month (static, carousel, mixed media)",
